...
int main(int argc, char **argv)
{
	try
	{
		...
		dodoString ts = dodoString(1000000, 'l') + dodoString(1000000, 'i') + dodoString(1000000, 'b') + dodoString(1000000, 'd') + dodoString(1000000, 'o') + dodoString(1000000, 'd') + dodoString(1000000, 'o');

		cout << "ts = dodoString(1000000, 'l') + dodoString(1000000, 'i') + dodoString(1000000, 'b') + dodoString(1000000, 'd') + dodoString(1000000, 'o') + dodoString(1000000, 'd') + dodoString(1000000, 'o');" << endl;
		...
		cout << "MD5 of ts, should be 67314880276cfa6c63c3276f7c3820ce" << endl;
		cout << "MD5 of ts,        is " << tools::code::MD5Hex(ts) <<  endl;
		...
		cout << "SHA-1 of ts, should be 759643681255032e13ddc81d839518f21804d854" << endl;
		cout << "SHA-1 of ts,        is " << tools::code::SHA1Hex(ts) <<  endl;
		...
		cout << "SHA-256 of ts, should be a900f98ea455478f5b4ba820250ea4964982f64d56f1fc0b132d3c19204634ee" << endl;
		cout << "SHA-256 of ts,        is " << tools::code::SHA256Hex(ts) <<  endl;
		...
		cout << "SHA-512 of ts, should be d64cdf8f171e1474423a002c0627be1c10bfb0d6c84ffcb555d9eca7c033504c38fb0f41e1ef0e1c86d6c61b1c09100a7192566f18dc5ecc9aa8121a50b521e7" << endl;
		cout << "SHA-512 of ts,        is " << tools::code::SHA512Hex(ts) <<  endl;
