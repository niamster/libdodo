								  ...
								  bool flag)
{
	...
	switch (option)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_IOSOCKETOPTIONS, IOSOCKETOPTIONSEX_SETSOCKOPT, ERR_LIBDODO, IOSOCKETOPTIONSEX_WRONG_PARAMETER, IOSOCKETOPTIONSEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
										...
										int seconds)
{
	...
	switch (option)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_IOSOCKETOPTIONS, IOSOCKETOPTIONSEX_SETLINGERSOCKOPT, ERR_LIBDODO, IOSOCKETOPTIONSEX_WRONG_PARAMETER, IOSOCKETOPTIONSEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
