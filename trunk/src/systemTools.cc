					  ...
					  __limits &lim)
{
	...
	switch (type)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_SYSTEMTOOLS, SYSTEMTOOLSEX_GETLIMIT, ERR_LIBDODO, SYSTEMTOOLSEX_WRONG_PARAMETER, SYSTEMTOOLSEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
					  ...
					  const __limits &lim)
{
	...
	switch (type)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_SYSTEMTOOLS, SYSTEMTOOLSEX_SETLIMIT, ERR_LIBDODO, SYSTEMTOOLSEX_WRONG_PARAMETER, SYSTEMTOOLSEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
...
systemTools::getUID(short type)
{
	switch (type)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_SYSTEMTOOLS, SYSTEMTOOLSEX_GETUID, ERR_LIBDODO, SYSTEMTOOLSEX_WRONG_PARAMETER, SYSTEMTOOLSEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
}
					...
					int uid)
{
	...
	switch (type)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_SYSTEMTOOLS, SYSTEMTOOLSEX_SETUID, ERR_LIBDODO, SYSTEMTOOLSEX_WRONG_PARAMETER, SYSTEMTOOLSEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
...
systemTools::getGID(short type)
{
	switch (type)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_SYSTEMTOOLS, SYSTEMTOOLSEX_GETGID, ERR_LIBDODO, SYSTEMTOOLSEX_WRONG_PARAMETER, SYSTEMTOOLSEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
}
					...
					int uid)
{
	...
	switch (type)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_SYSTEMTOOLS, SYSTEMTOOLSEX_SETGID, ERR_LIBDODO, SYSTEMTOOLSEX_WRONG_PARAMETER, SYSTEMTOOLSEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
