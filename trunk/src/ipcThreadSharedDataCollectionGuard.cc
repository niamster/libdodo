...
dataCollectionGuard::del(unsigned long position)
{
	...
	if (getShare(position))
		...
		throw baseEx(ERRMODULE_IPCTHREADSHAREDDATACOLLECTIONGUARD, DATACOLLECTIONGUARDEX_DEL, ERR_LIBDODO, DATACOLLECTIONGUARDEX_NOTFOUND, DATACOLLECTIONGUARDEX_NOTFOUND_STR, __LINE__, __FILE__);
}
										   ...
										   void          *data)
{
	...
	if (getShare(position))
		...
		throw baseEx(ERRMODULE_IPCTHREADSHAREDDATACOLLECTIONGUARD, DATACOLLECTIONGUARDEX_SET, ERR_LIBDODO, DATACOLLECTIONGUARDEX_NOTFOUND, DATACOLLECTIONGUARDEX_NOTFOUND_STR, __LINE__, __FILE__);
}
