/***************************************************************************
 *            ipcThreadSharedDataCollectionGuard.cc
 *
...
dataCollectionGuard::del(unsigned long position)
{
	...
	if (getShare(position))
		...
		throw exception::basic(exception::ERRMODULE_IPCTHREADSHAREDDATACOLLECTIONGUARD, DATACOLLECTIONGUARDEX_DEL, exception::ERRNO_LIBDODO, DATACOLLECTIONGUARDEX_NOTFOUND, IPCTHREADSHAREDDATACOLLECTIONGUARDEX_NOTFOUND_STR, __LINE__, __FILE__);
}
						 ...
						 void          *data)
{
	...
	if (getShare(position))
		...
		throw exception::basic(exception::ERRMODULE_IPCTHREADSHAREDDATACOLLECTIONGUARD, DATACOLLECTIONGUARDEX_SET, exception::ERRNO_LIBDODO, DATACOLLECTIONGUARDEX_NOTFOUND, IPCTHREADSHAREDDATACOLLECTIONGUARDEX_NOTFOUND_STR, __LINE__, __FILE__);
}
