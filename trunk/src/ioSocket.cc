...
ioSocket::makeSocket()
{
	...
	switch (family)
	{
		...
		default:
			...
			throw baseEx(ERRMODULE_IOSOCKET, IOSOCKETEX_MAKESOCKET, ERR_LIBDODO, IOSOCKETEX_WRONG_PARAMETER, IOSOCKETEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
					...
					__connInfo &info)
{
	...
	switch (family)
	{
		...
		default:
			throw baseEx(ERRMODULE_IOSOCKET, IOSOCKETEX_ACCEPT, ERR_LIBDODO, IOSOCKETEX_WRONG_PARAMETER, IOSOCKETEX_WRONG_PARAMETER_STR, __LINE__, __FILE__);
	}
