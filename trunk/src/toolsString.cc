...
bool string::equal(const dodoString &first,
...
bool string::iequal(const dodoString &first,
					const dodoString &second)
{
	unsigned long firstSize = first.size();
...
bool string::contains(const dodoString &str,
...
unsigned long string::find(const dodoString &str,
						   const dodoString &needle,
...
dodoString string::format(const dodoString &format,
						  ...)
{
...
dodoString string::lToString(long number)
{
	char temp[SIZEOFNUM];
...
dodoString string::ulToString(unsigned long number)
{
	char temp[SIZEOFNUM];
	sprintf(temp, "%ld", number);
...
dodoString string::iToString(int number)
{
	char temp[SIZEOFNUM];
...
dodoString string::uiToString(unsigned int number)
{
	char temp[SIZEOFNUM];
...
dodoString string::sToString(short number)
{
	char temp[SIZEOFNUM];
...
dodoString string::usToString(unsigned short number)
{
	char temp[SIZEOFNUM];
	sprintf(temp, "%sd", number);
...
dodoString string::fToString(float number)
{
	char temp[SIZEOFNUM];
...
dodoString string::dToString(double number)
{
	char temp[SIZEOFNUM];
	sprintf(temp, "%f", number);
...
dodoString string::lTrim(const dodoString &data,
						 char             symbol)
{
...
dodoString string::rTrim(const dodoString &data,
						 char             symbol)
{
	int i(data.size() - 1);
...
dodoString string::trim(const dodoString &data,
						const char       symbols[],
						int              symCount)
{
...
long string::stringToL(const dodoString &data)
{
...
unsigned long string::stringToUL(const dodoString &data)
{
...
int string::stringToI(const dodoString &data)
{
...
unsigned int string::stringToUI(const dodoString &data)
{
...
short string::stringToS(const dodoString &data)
{
...
unsigned short string::stringToUS(const dodoString &data)
{
...
float string::stringToF(const dodoString &data)
{
...
double string::stringToD(const dodoString &data)
{
...
void string::replace(const dodoStringArray &needle,
...
void string::replace(const dodoString &needle,
