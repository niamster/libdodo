...
#ifndef _PCPROCESSSHAREDDATAGUARD_H_
#define _PCPROCESSSHAREDDATAGUARD_H_
...
#include <libdodo/pcProcessSharedDataGuardEx.h>
#include <libdodo/pcSharedDataGuard.h>
	...
	namespace pc
	{
		namespace process
		{
			namespace shared
			{
				 ...
				 */
				class dataGuard : public pc::shared::dataGuard
				{
					private:
