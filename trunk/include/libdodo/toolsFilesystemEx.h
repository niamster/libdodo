...
namespace dodo
{
	namespace tools
	{
		 ...
		 */
	#define FILESYSTEMEX_WRONGFILENAME_STR "Probably wrong filename, type of file is wrong or `path` is empty!"
	#define FILESYSTEMEX_DESTINATIONEXISTS_STR "Destination file/dir/etc. exists. Won't overvrite"
	#define FILESYSTEMEX_NOTADIR_STR "There is not a dir with given path."
	#define FILESYSTEMEX_TOOLONGPATH_STR "Too long path."
