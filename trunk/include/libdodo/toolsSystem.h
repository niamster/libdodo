...
#ifndef _TOOLSSYSTEM_H_
#define _TOOLSSYSTEM_H_
...
namespace dodo
{
	...
	{
		TOOLSSYSTEM_CPUTIME,
		TOOLSSYSTEM_MAXFILESIZE,
		TOOLSSYSTEM_MAXMEMUSAGE,
		TOOLSSYSTEM_MAXSTACK,
		TOOLSSYSTEM_MAXPROC,
		TOOLSSYSTEM_MAXOPENFILES
	};
	...
	{
		TOOLSSYSTEM_SIGNAL_HANGUP = 0,
		TOOLSSYSTEM_SIGNAL_INTERRUPT = 1 << 1,
		TOOLSSYSTEM_SIGNAL_QUIT = 1 << 2,
		TOOLSSYSTEM_SIGNAL_ILLEGAL_INSTRUCTION = 1 << 3,
		TOOLSSYSTEM_SIGNAL_ABORT = 1 << 4,
		TOOLSSYSTEM_SIGNAL_BUS_FAULT = 1 << 5,
		TOOLSSYSTEM_SIGNAL_FLOATINGPOINT_FAULT = 1 << 6,
		TOOLSSYSTEM_SIGNAL_USER_DEFINED1 = 1 << 7,
		TOOLSSYSTEM_SIGNAL_SEGMENTATION_FAULT = 1 << 8,
		TOOLSSYSTEM_SIGNAL_USER_DEFINED2 = 1 << 9,
		TOOLSSYSTEM_SIGNAL_PIPE_FAULT = 1 << 10,
		TOOLSSYSTEM_SIGNAL_ALARM = 1 << 11,
		TOOLSSYSTEM_SIGNAL_TERMINATION = 1 << 12,
		TOOLSSYSTEM_SIGNAL_CHILD_CHANGED = 1 << 13,
		TOOLSSYSTEM_SIGNAL_CONTINUE = 1 << 14,
		TOOLSSYSTEM_SIGNAL_KEYBOARD_STOP = 1 << 15,
		TOOLSSYSTEM_SIGNAL_CPULIMIT_EXCEEDED = 1 << 16,
		TOOLSSYSTEM_SIGNAL_FILESIZE_EXCEEDED = 1 << 17,
		TOOLSSYSTEM_SIGNAL_BAD_SYSCALL = 1 << 18,
	};
