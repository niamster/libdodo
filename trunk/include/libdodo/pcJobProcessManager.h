...
#ifndef _PCJOBPROCESSMANAGER_H_
#define _PCJOBPROCESSMANAGER_H_ 1
	...
	namespace pc {
		namespace job {
			namespace process {
				 ...
				 * @note name in the library must be initPcJobProcessManagerModule
				 */
				 ...
				 * @note name in the library must be deinitPcJobProcessManagerModule
				 */
