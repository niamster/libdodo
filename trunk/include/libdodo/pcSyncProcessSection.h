	...
	namespace pc
	{
		namespace sync
		{
			namespace process
			{
				 ...
				 * @note if the key was autogenerated the semaphore is not removed from the system
				 * you should call remove to remove it from the system
				 * for XSI initial value is 0, for POSIX is 1
				 */
				class section : public sync::section
				{
					public:
						 ...
						 */
						section(int value = SEMAPHORE_INITIAL_VALUE, int key = 0);
					...
					protected:
						...
						int value; ///< semaphore initial value
				};
			};
		};
	};
