...
#ifndef _IOCGIFASTEXCHANGE_H_
#define _IOCGIFASTEXCHANGE_H_
...
namespace dodo
{
	 ...
	 */
	enum cgiFastExchangeOperationTypeEnum
	{
		IOCGIFASTEXCHANGE_OPERATION_READ,
		IOCGIFASTEXCHANGE_OPERATION_READSTRING,
		IOCGIFASTEXCHANGE_OPERATION_READSTREAM,
		IOCGIFASTEXCHANGE_OPERATION_READSTREAMSTRING,
		IOCGIFASTEXCHANGE_OPERATION_WRITE,
		IOCGIFASTEXCHANGE_OPERATION_WRITESTRING,
		IOCGIFASTEXCHANGE_OPERATION_WRITESTREAM,
		IOCGIFASTEXCHANGE_OPERATION_WRITESTREAMSTRING,
	};
