...
namespace dodo
{
	...
	{
		TOOLSFILESYSTEM_FILETYPE_REGULAR_FILE,
		TOOLSFILESYSTEM_FILETYPE_LOCAL_SOCKET,
		TOOLSFILESYSTEM_FILETYPE_SYMBOLIC_LINK,
		TOOLSFILESYSTEM_FILETYPE_BLOCK_DEVICE,
		TOOLSFILESYSTEM_FILETYPE_DIRECTORY,
		TOOLSFILESYSTEM_FILETYPE_CHARACTER_DEVICE,
		TOOLSFILESYSTEM_FILETYPE_FIFO
	};
	...
	enum ioDiskPermissionModesEnum
	{
		...
		TOOLSFILESYSTEM_PERM_OWNER_READ_ACCESS = 1 << 1,
		TOOLSFILESYSTEM_PERM_GROUP_READ_ACCESS = 1 << 2,
		TOOLSFILESYSTEM_PERM_OTHER_READ_ACCESS = 1 << 3,

		TOOLSFILESYSTEM_PERM_OWNER_WRITE_ACCESS = 1 << 4,
		TOOLSFILESYSTEM_PERM_GROUP_WRITE_ACCESS = 1 << 5,
		TOOLSFILESYSTEM_PERM_OTHER_WRITE_ACCESS = 1 << 6,

		TOOLSFILESYSTEM_PERM_OWNER_EXECUTE_ACCESS = 1 << 7,
		TOOLSFILESYSTEM_PERM_GROUP_EXECUTE_ACCESS = 1 << 8,
		TOOLSFILESYSTEM_PERM_OTHER_EXECUTE_ACCESS = 1 << 9,

		TOOLSFILESYSTEM_PERM_STICKY_ACCESS = 1 << 10,

		TOOLSFILESYSTEM_PERM_SUID_ACCESS = 1 << 11,
		TOOLSFILESYSTEM_PERM_SGID_ACCESS = 1 << 12,

		TOOLSFILESYSTEM_PERM_OWNER_ALL_ACCESS = TOOLSFILESYSTEM_PERM_OWNER_READ_ACCESS | TOOLSFILESYSTEM_PERM_OWNER_WRITE_ACCESS | TOOLSFILESYSTEM_PERM_OWNER_EXECUTE_ACCESS,
		TOOLSFILESYSTEM_PERM_GROUP_ALL_ACCESS = TOOLSFILESYSTEM_PERM_GROUP_READ_ACCESS | TOOLSFILESYSTEM_PERM_GROUP_WRITE_ACCESS | TOOLSFILESYSTEM_PERM_GROUP_EXECUTE_ACCESS,
		TOOLSFILESYSTEM_PERM_OTHER_ALL_ACCESS = TOOLSFILESYSTEM_PERM_OTHER_READ_ACCESS | TOOLSFILESYSTEM_PERM_OTHER_WRITE_ACCESS | TOOLSFILESYSTEM_PERM_OTHER_EXECUTE_ACCESS,

		TOOLSFILESYSTEM_PERM_ALL_ALL_ACCESS = TOOLSFILESYSTEM_PERM_OWNER_ALL_ACCESS | TOOLSFILESYSTEM_PERM_GROUP_ALL_ACCESS | TOOLSFILESYSTEM_PERM_OTHER_ALL_ACCESS,
