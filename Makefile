...
OBJECTS=dbBase.o dodoBase.o tools.o xexec.o sqlBaseEx.o sqlBase.o baseEx.o mysqlpp.o mysqlppEx.o cgipp.o regexp.o flush.o flushSocket.o cgippEx.o regexpEx.o flushDisk.o flushDiskEx.o
