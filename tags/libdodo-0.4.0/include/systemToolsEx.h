...
#include <baseEx.h>
	...
	{	
		...
		enum systemFunctionsID
		{
			...
			SYSTEMTOOLS_ATEXIT,
			SYSTEMTOOLS_GETGROUPPID,
			SYSTEMTOOLS_SETGROUPPID,
			SYSTEMTOOLS_SETSIGNALHANDLER,
			SYSTEMTOOLS_UNSETSIGNALHANDLER,
			SYSTEMTOOLS_GETMODULEINFO,
			SYSTEMTOOLS_SENDSIGNAL,
			SYSTEMTOOLS_SETTIMER,
			SYSTEMTOOLS_SETMICROTIMER,
		};
	};
