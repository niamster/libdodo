...
class db_driver_mysql {
	...
	public function insert($table, $array)
	{
		...
		$this->cur_query = 'INSERT INTO ' . $this->obj['sql_tbl_prefix'] . $table . ' (' . 
	...
	public function update($table, $set, $where, $low_priority = "" )
	{
		...
		$this->cur_query = 'UPDATE ' . $low_priority . ' ' . $this->obj['sql_tbl_prefix'] . 
							$table . ' SET ' . $set;
	...
	public function select($table, $fields, $where="" )
    {
    	...
    	$this->cur_query = 'SELECT ' . $fields . ' FROM ' . $this->obj['sql_tbl_prefix'] . $table;
    ...
    private function query($the_query = '', $bypass=0)
    {
    ...
    function fatal_error($the_error="")
    {
        ...
        //throw new DatabaseException('000', 'db_mysql', $the_error);
    }
