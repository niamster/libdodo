     ...
     char **argv UNUSED)
{
    dodo_try {
        ...
        im.write(file::regular("test-0.jpg", file::regular::OPEN_MODE_READ_WRITE_TRUNCATE), image::ENCODER_JPEG);
        ...
        im.write(file::regular("test-1.jpg", file::regular::OPEN_MODE_READ_WRITE_TRUNCATE), image::ENCODER_JPEG);
        ...
        im.write(file::regular("new-0.png", file::regular::OPEN_MODE_READ_WRITE_TRUNCATE), image::ENCODER_PNG);

        im.read(file::regular("new-0.png", file::regular::OPEN_MODE_READ_ONLY));
        im.removeAlpha();
        im.write(file::regular("new-1.png", file::regular::OPEN_MODE_READ_WRITE_TRUNCATE), image::ENCODER_PNG);
        ...
        im.write(file::regular("new-2.png", file::regular::OPEN_MODE_READ_WRITE_TRUNCATE), image::ENCODER_PNG);
        ...
        im.write(file::regular("new-3.png", file::regular::OPEN_MODE_READ_WRITE_TRUNCATE), image::ENCODER_PNG);
        ...
        im.write(file::regular("new-4.png", file::regular::OPEN_MODE_READ_WRITE_TRUNCATE), image::ENCODER_PNG);
