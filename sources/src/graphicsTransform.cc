                 ...
                 unsigned long height)
{
    if (image.collectedData.handle->im == NULL)
        dodo_throw exception::basic(exception::MODULE_GRAPHICSTRANSFORM, TRANSFORMEX_SCALE, exception::ERRNO_IMAGEMAGICK, TRANSFORMEX_EMPTYIMAGE, GRAPHICSTRANSFORMEX_EMPTYIMAGE_STR, __LINE__, __FILE__);
    ...
    if (im == NULL)
        dodo_throw exception::basic(exception::MODULE_GRAPHICSTRANSFORM, TRANSFORMEX_SCALE, exception::ERRNO_IMAGEMAGICK, ((ExceptionInfo *)image.exInfo)->error_number, ((ExceptionInfo *)image.exInfo)->reason, __LINE__, __FILE__, ((ExceptionInfo *)image.exInfo)->description ? ((ExceptionInfo *)image.exInfo)->description : __dodostring__);
...
{
    if (image.collectedData.handle->im == NULL)
        dodo_throw exception::basic(exception::MODULE_GRAPHICSTRANSFORM, TRANSFORMEX_ROTATE, exception::ERRNO_IMAGEMAGICK, TRANSFORMEX_EMPTYIMAGE, GRAPHICSTRANSFORMEX_EMPTYIMAGE_STR, __LINE__, __FILE__);

    GetExceptionInfo((ExceptionInfo *)image.exInfo);

    Image *im = RotateImage(image.collectedData.handle->im, angle, (ExceptionInfo *)image.exInfo);
    if (im == NULL)
        dodo_throw exception::basic(exception::MODULE_GRAPHICSTRANSFORM, TRANSFORMEX_ROTATE, exception::ERRNO_IMAGEMAGICK, ((ExceptionInfo *)image.exInfo)->error_number, ((ExceptionInfo *)image.exInfo)->reason, __LINE__, __FILE__, ((ExceptionInfo *)image.exInfo)->description ? ((ExceptionInfo *)image.exInfo)->description : __dodostring__);
