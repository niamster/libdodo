...
rmake += [ "'%(trove)s[" + ",".join([x for x in uses if x not in ("dl", "fcgi", "bzip2")]) + "]'" ]
rmake += [ "'%(trove)s[" + ",".join([x for x in uses if x not in ("postgresql", "sqlite3", "dl", "fcgi", "bzip2")]) + "]'" ]
rmake += [ "'%(trove)s[" + ",".join([x for x in uses if x not in ("mysql", "sqlite3", "dl", "fcgi", "bzip2")]) + "]'" ]
rmake += [ "'%(trove)s[" + ",".join([x for x in uses if x not in ("postgresql", "mysql", "dl", "fcgi", "bzip2")]) + "]'" ]
